...
- `src/branding.ts`: dashboard identity. Keep the exact title `CollectiveX · Mori Internal dashboard` in both locales, and the `MORI Internal` watermark embedded in chart SVGs and PNG exports; do not translate the watermark.
